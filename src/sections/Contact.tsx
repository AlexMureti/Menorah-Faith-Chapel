...
const content = {
  ...
  appointment: {
    ...
    subtitle: {
      en: 'Schedule a meeting with Apostle Isaack Muriungi for ministry consultation, prayer, or prophetic guidance.',
      es: 'Programar una reunión con el Apóstol Isaack Muriungi para consulta ministerial, oración o guía profética.',
      fr: 'Planifier une réunion avec l\'Apôtre Isaack Muriungi pour consultation ministérielle, prière ou guidance prophétique.',
      pt: 'Agendar uma reunião com o Apóstolo Isaack Muriungi para consulta ministerial, oração ou orientação profética.',
      de: 'Ein Treffen mit Apostel Isaack Muriungi für Ministeriumsberatung, Gebet oder prophetische Führung planen.',
